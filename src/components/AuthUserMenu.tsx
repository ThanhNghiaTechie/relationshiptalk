      ...
      <Link
        ...
        className={
          compact
            ...
            : 'flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-muted-foreground hover:bg-muted hover:text-foreground'
        }
      >
  ...
  return (
    <div className="relative">
      <button
        ...
        className={
          compact
            ? 'profile-avatar-ring flex h-9 w-9 items-center justify-center'
      ...
      {open && (
        <div
          className={
            compact
              ? 'absolute right-0 top-12 z-50 w-48 rounded-xl border border-border bg-card p-1 shadow-card'
              : 'absolute bottom-12 left-0 z-50 w-56 rounded-xl border border-border bg-card p-1 shadow-card'
          }
        >
