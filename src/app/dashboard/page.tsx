    ...
    <AppLayout activeRoute="/dashboard">
      <section className="px-4 py-8 lg:px-0">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Đây là không gian riêng của bạn trên RelationshipTalk.
        </p>
...
function DashboardLink({
  ...
  return (
    <a
      href={href}
      className="rounded-xl border border-border bg-card p-5 shadow-card transition hover:border-primary hover:shadow-md"
    >
